...
import { FileText, Globe, Eye, Plus, Search, Mail, BarChart2, ArrowRight, Clock, Layers, Navigation, Image as ImageIcon, Megaphone } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  const stats = [
    { label: "Total Pages", value: total, icon: FileText, color: "#2070B8", bg: "#eff6ff" },
    { label: "Published", value: published, icon: Eye, color: "#16a34a", bg: "#f0fdf4" },
    { label: "Drafts", value: draft, icon: Clock, color: "#d97706", bg: "#fffbeb" },
    { label: "Languages", value: 4, icon: Globe, color: "#7c3aed", bg: "#f5f3ff" },
  ];
